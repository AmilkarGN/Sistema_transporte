...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('shipments', function (Blueprint $table) {
            // Modificar la columna 'status' a VARCHAR(50)
            // Esto asegurará que todos los estados definidos en el formulario quepan.
            ...
            // para incluir todos los valores posibles ('Pending', 'Processing', 'In Transit', 'Delivered', 'Cancelled').
    ...
    public function down(): void
    {
        Schema::table('shipments', function (Blueprint $table) {
            ...
            $table->string('status', 25)->change(); // Revertir a una longitud menor (ajusta si es necesario)
        });
    }
};
